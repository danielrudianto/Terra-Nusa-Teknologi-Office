...
certificate_of_payments_table = Table(
    ...
    Column("isCopCreated", Boolean, nullable=False, server_default=text("0")),
    Column("copCreatedBy", Integer, ForeignKey("users.id"), nullable=True),
    Column("copCreatedAt", DateTime, nullable=True),
